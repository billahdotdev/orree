  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        display: ["'Anek Bangla'", "'Anek Fallback'", "'Hind Siliguri'", "sans-serif"],
        // Body: calm, highly legible Bengali sans
        body: ["'Hind Siliguri'", "'Hind Fallback'", "'Anek Bangla'", "sans-serif"],
        // Quote/nostalgia accent. Noto Serif Bengali was dropped from the font
        // payload — a third Bengali family cost ~150KB in front of first paint
        // to style a single pull-quote. Anek Bangla at a lighter weight plus
        // the system Bengali serif carries the same editorial feel for free.
        quote: ["'Anek Bangla'", "'Anek Fallback'", "Kalpurush", "serif"],
      },
      backgroundImage: {
      ...
      animation: {
        ...
        "bump": "bump 0.45s cubic-bezier(0.16,1,0.3,1)",
