...
export default function Footer({ brand }) {
  ...
  return (
    <footer id="contact" className="relative bg-green-deeper border-t border-cream/10 pt-16 pb-28 sm:pb-8 scroll-mt-20">
            ...
            <ul className="space-y-3 text-[14px] text-cream/65">
              ...
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2.5 hover:text-amber transition-colors"
                >
                  <WhatsAppIcon size={15} className="text-amber shrink-0" />
