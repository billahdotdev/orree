          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {totalCount > 0 && (
              <button
                ...
                className="tap relative flex items-center justify-center h-10 w-10 rounded-full glass hover:border-amber/50 transition-colors duration-200"
              >
                <ShoppingBag size={18} className="text-cream" />
                <span
                  key={totalCount}
                  aria-live="polite"
                  className="animate-bump absolute -top-1.5 -right-1.5 flex items-center justify-center h-5 w-5 rounded-full bg-amber text-[11px] font-semibold text-cream tabular-nums"
                >
                  {totalCount}
                </span>
              </button>
            ...
            <a
              ...
              className="hidden sm:inline-flex items-center gap-1.5 rounded-full bg-amber px-5 py-2.5 text-[14px] font-display font-semibold text-cream transition-all duration-300 hover:bg-amber-deep"
            >
              অর্ডার করুন
            </a>
